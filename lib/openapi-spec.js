// Complete OpenAPI specification for German School Holidays API
// This is used as a fallback when the YAML file cannot be loaded
...
module.exports = {
  ...
  tags: [
    { name: 'V1 (Legacy)', description: 'Original API endpoints - backward compatible' },
    { name: 'V2 (Enhanced)', description: 'Enhanced API with advanced filtering and new features' },
  ...
  paths: {
    ...
    '/api/v1/{year}/{state}': {
      get: {
        ...
        responses: {
          ...
          '404': { description: 'No holidays found for the specified criteria' }
        }
      }
    },
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            in: 'query',
            schema: { type: 'string' },
            example: 'start,end,name,stateCode',
        ...
        responses: {
          ...
          '404': { description: 'No holidays found matching criteria' }
        }
      }
    },
    ...
    '/api/v2/{year}/{state}': {
      get: {
        ...
        parameters: [
          ...
          { name: 'state', in: 'path', required: true, schema: { type: 'string' }, example: 'BY' },
    ...
    '/api/v2/current': {
      get: {
        ...
        parameters: [
          { name: 'states', in: 'query', schema: { type: 'string' }, example: 'BY,BW' },
          { name: 'fields', in: 'query', schema: { type: 'string' } }
        ],
        responses: {
          '200': {
      ...
      get: {
        ...
        responses: {
          '200': {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/YearStats' }
              }
            }
          }
        }
    ...
    '/api/v2/compare/{yearA}/{yearB}': {
      get: {
        ...
        parameters: [
          { name: 'yearA', in: 'path', required: true, schema: { type: 'integer' }, example: 2024 },
          { name: 'yearB', in: 'path', required: true, schema: { type: 'integer' }, example: 2025 }
        ],
        responses: {
          '200': {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/YearComparison' }
              }
            }
          }
        }
    ...
    schemas: {
      Holiday: {
        ...
        properties: {
          start: {
            ...
            type: 'string',
            format: 'date-time',
            example: '2024-09-08T00:00Z',
            description: 'End date of holiday (ISO 8601)'
          },
          year: {
            type: 'integer',
            example: 2024,
      ...
      YearStats: {
        ...
        properties: {
          ...
          longestHoliday: { $ref: '#/components/schemas/Holiday' },
          shortestHoliday: { $ref: '#/components/schemas/Holiday' }
        }
      },
      ...
      YearComparison: {
        ...
        properties: {
          yearA: { type: 'integer' },
          yearB: { type: 'integer' },
          totalHolidaysA: { type: 'integer' },
          totalHolidaysB: { type: 'integer' },
